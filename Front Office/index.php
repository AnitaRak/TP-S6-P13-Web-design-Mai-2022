        ...
        <div class="container bcontent">
            ...
            <div class="card" style="width: 800px;">
                <div class="row no-gutters">
                    <div class="col-sm-2">
                        <img class="card-img" src="https://echauffement-climatique.herokuapp.com/Back%20Office/image/productionEnergie.jpg" alt="Suresh Dasari Card" width="50" height="50">
                    </div>
                    <div class="col-sm-10">
                        <div class="card-body">
            ...
            <div class="card" style="width: 800px;">
                <div class="row no-gutters">
                    <div class="col-sm-2">
                        <img class="card-img" src="https://echauffement-climatique.herokuapp.com/Back%20Office/image/productionIndustrielle.jpg" alt="Suresh Dasari Card" width="50" height="50">
                    </div>
                    <div class="col-sm-10">
                        <div class="card-body">
            ...
            <div class="card" style="width: 800px;">
                <div class="row no-gutters">
                    <div class="col-sm-2">
                        <img class="card-img" src="https://echauffement-climatique.herokuapp.com/Back%20Office/image/deforestation1.jpg" alt="Suresh Dasari Card" width="50" height="50">
                    </div>
                    <div class="col-sm-10">
                        <div class="card-body">
